> ## Baca ini dulu — dokumen ini berasal dari app lain
>
> **Diterima 21 Agustus 2026** lewat `.orca/drops/`. Disimpan apa adanya mulai
> baris "# Product Requirements Document" di bawah; tidak ada satu kata pun
